...
export const WS_CONNECTION_SUCCESS: "WS_CONNECTION_SUCCESS" =
  "WS_CONNECTION_SUCCESS"; //при успешном соединении
export const WS_CONNECTION_ERROR: "WS_CONNECTION_ERROR" = "WS_CONNECTION_ERROR"; //в случае ошибки соединения
export const WS_CONNECTION_CLOSED: "WS_CONNECTION_CLOSED" =
  "WS_CONNECTION_CLOSED"; //при закрытии соединения
export const WS_GET_ORDERS: "WS_GET_ORDERS" = "WS_GET_ORDERS"; //при получении сообщения от сервера
