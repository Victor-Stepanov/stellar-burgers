import { WS_CONNECTION_START, WS_CONNECTION_SUCCESS, WS_CONNECTION_ERROR, WS_CONNECTION_CLOSED, WS_GET_ORDERS, WS_SEND_ORDERS } from "../action-types";
import { TFeedResponce } from "../types/data";

export type TWsActions = IWsConnectionOpen|IWsConnectionSuccess|IWsConnectionError|IWsConnectionClosed|IWsGetOrders|IWsSendOrders;
