...
const OrderInfo:FC = () => {
	...
	const uniqIngredients = [...new Set(filterArr)] as Array<TIngrediens>; //массив уникальных ингредиентов
				...
				<div className={styles.container}>
					...
					<ul className={styles.list}>
						...
						<div className={styles.scroll}>
							{uniqIngredients.map((item:TIngrediens, index:number) =>
								<li className={styles.item} key={index} >
									...
									<div className={styles.price}>
										<p className={`text text_type_digits-default pr-2`}>{countIngredients(filterArr as Array<TIngrediens>, item.name)}x{item.price}</p>
